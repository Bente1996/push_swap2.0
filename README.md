...
- your program displays the amount of operations needed to sort given integers, 
...
- medium sized lists (21-149) are sorted by splitting the list in four and then
sorting those four quarters by looking for two pairs of three integers in each
